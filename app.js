(() => {
  ...
  const CMDS = {
    ...
    work: () => 'assay-gpu + LADING + PLIMSOLL [3 DOIs]  AEGIS [edge/QNX]  Cairn [robot integrity]  Vernier [agent eval]  Mayfly [microVM]  Plumbline [transparency log]  AeroGuard [SOC triage · MLH award]\n→ github.com/GautamTalksDev',
